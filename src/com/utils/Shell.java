 ...
 * @Description: 网上开源项目https://github.com/jjNford/android-shell
 *               </p>
 *               顺序执行的Shell
 * @Create: 2015年9月15日 下午6:01:33
 * @Author: sanbo
 */
public class Shell {
     ...
     */
    private static String nativeExec(String cmd) {
        Process proc = null;
        Buffer buffer = null;
        try {
     ...
     * @throws ShellException
     */
    private static String suExec(String cmd) {
        try {
     ...
     * @throws ShellException
     */
    private static void setSuShell() {
        try {
     ...
     * @throws IOException
     */
    synchronized public static String sudo(String cmd) {
        try {
            if (Shell.su()) {
     ...
     * @throws ShellException
     */
    synchronized public static String exec(String cmd) {
        try {
